 ...
 *
 * Must match frontend/src/lib/tdsCodes.js.
 */
...
export const TDS_OLD_CODE_SET = new Set(TDS_OLD_CODES.map((c) => c.code));
export const TDS_NEW_CODE_SET = new Set(TDS_NEW_CODES.map((c) => c.code));
